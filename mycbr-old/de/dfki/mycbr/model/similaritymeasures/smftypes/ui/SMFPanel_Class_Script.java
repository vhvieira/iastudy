...
public class SMFPanel_Class_Script extends SMFPanel implements DocumentListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private SMF_Class_Script smf;
	private SMFPanel_SMF_Test testPanel;
	// private JTextField tfLanguage; // currently unused
	...
	public SMFPanel_Class_Script(SMF_Class_Script smf) {
		super(smf);
		this.smf = smf;
